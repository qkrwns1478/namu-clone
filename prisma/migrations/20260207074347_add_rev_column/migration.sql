...
INSERT INTO "new_WikiRevision" ("authorId", "comment", "content", "createdAt", "id", "ipAddress", "pageId", "rev") SELECT "authorId", "comment", "content", "createdAt", "id", "ipAddress", "pageId", "rev" FROM "WikiRevision";
